...
public:
    ...
    friend void master_pack_for_broadcast(class Master* S, std::vector<char>& buf);
    friend void master_unpack_from_broadcast(class Master* S, const std::vector<char>& buf);
};
