...
class Master {  /* control all master information and process */
    ...
    public:
        ...
        unsigned int GetNplayer() const {return iNplayer;}
        ...
        friend void master_pack_for_broadcast(Master* S, std::vector<char>& buf);
        friend void master_unpack_from_broadcast(Master* S, const std::vector<char>& buf);
};
